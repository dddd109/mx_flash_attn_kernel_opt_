...
## 最终 (2026-09-05, 最后30分钟)
- 用户提交了一版 case14=148 (67.21)。67.36 赢家是 case14=100。
- **务必提交 submission_clean.cu** (case14 ns=100) = 67.36 版。
- case9 ns=11 复核最优。case7/9 有 run-to-run ±0.01ms 波动（非代码差异）。
